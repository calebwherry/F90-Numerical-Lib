...
program threePointMidpoint1stDeriv
  ...
  write(6,*)
  write(6,*) 'Three-Point Midpoint Formula Approx for 1st Derivative'
  do i=1,n
    write(6,*) 'i = ' ,i, 'h = ' ,h, " f'(x) = " , threePointMidpoint1st(x,h)
    h = h/2.0d0
  end do
  write(6,*)
  
end program threePointMidpoint1stDeriv
